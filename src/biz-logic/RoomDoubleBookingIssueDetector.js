...
let RoomDoubleBookingIssueDetector = (module.exports = function() {});

RoomDoubleBookingIssueDetector.prototype.warnings = function(schedule) {
...
let conflictDescriptionFor = function(event) {
  ...
  return {
    ...
    desc: `${event.room} has a time conflict on ${dayOfWeek}s between ${event.course}-${event.section} and ${this.course}-${this.section}`
  };
};
